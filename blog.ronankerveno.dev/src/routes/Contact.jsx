    ...
    <form ref={form} onSubmit={sendEmail} className=" bg-slate-300 text-slate-700 p-8 rounded-md">
      ...
      <div className="text-right">
        <input
          type="submit"
          value="Envoi"
          className="bg-white text-slate-900 py-1 px-4 rounded-md cursor-pointer transition ease-in-out duration-150 hover:bg-slate-300 hover:text-white active:bg-slate-700"
        />
      </div>
    </form>
  );
