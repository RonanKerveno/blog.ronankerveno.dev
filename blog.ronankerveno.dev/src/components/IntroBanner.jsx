...
export default function IntroBanner() {
  return (
    <section 
      className= "mb-5 flex justify-between gap-4 border-y-2 border-slate-300 rounded-lg text-white py-5 bg-[url('../assets/bg-image.jpg')]"
    >
      <p className="bg-black bg-opacity-50 p-3">
